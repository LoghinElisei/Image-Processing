...
public:
    ...
    void show(const std::string& windowName) {
        ...
        int img_h = 400; // dimensiunea fiecărei imagini în grid
        int img_w = 400;
...
void iterative_region_growing(int x, int y, unsigned char *mask, unsigned char *img, int w, int h, unsigned char seed_val, unsigned char threshold);
